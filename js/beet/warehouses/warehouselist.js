Beet.registerMenu("warehouses", "whAdmin", "库存管理",
    [
	    ...
	    text: "库存管理",
	    handler: function(){
		var item = Beet.cache.menus["warehouses.warehouseList"];
		if (!item){
		    Beet.workspace.addPanel("warehouses.warehouseList", "库存管理", {
			items: [
			    Ext.create("Beet.apps.warehouses.warehouseList")
			]
		    });
		}else{
...
Ext.define("Beet.apps.warehouses.AddProduct", {
...
Ext.define("Beet.apps.warehouses.Exwarehouse", {
    extend: "Ext.panel.Panel",    
    height: "100%",
    width: "100%",
    layout: "fit",
    ...
    selectProducts: function(){
        ...
        var win = Ext.create("Ext.window.Window", config);
        win.show();
        win.add(Ext.create("Beet.apps.warehouses.warehouseList", {
            b_type: "selection",
            b_selectionMode: "MULTI",
            b_filter: " states = -1",
            b_selectionCallback: function(records){
...
Ext.define("Beet.apps.warehouses.warehouseList", {
    extend: "Ext.panel.Panel",
    autoHeight: true,
    autoScroll: true,
    height: "100%",
    ...
    buildStoreAndModel: function(metaData){
        ...
        if (!Ext.isDefined(Beet.apps.warehouses.warehouseModel)){
            Ext.define("Beet.apps.warehouses.warehouseModel", {
                extend: "Ext.data.Model",
                fields: fields
            });
        }

        if (!Ext.isDefined(Beet.apps.warehouses.warehouseStore)){
            Ext.define("Beet.apps.warehouses.warehouseStore", {
                extend: "Ext.data.Store",
                model: Beet.apps.warehouses.warehouseModel,
                autoLoad: true,
    ...
    createGrid: function(){
        ...
        Ext.apply(this, {
            storeProxy: Ext.create("Beet.apps.warehouses.warehouseStore")
        });
            ...
            tbar: [
                ...
                "-",
                {
                    ...
                    handler: function(){
                        ...
                        win.add(Ext.create("Beet.apps.warehouses.AddProduct", {
                            _editType: "add",
                            callback: function(){
                                win.close();
                ...
                "-",
                {
                    ...
                    handler: function(){
                        ...
                        win.add(Ext.create("Beet.apps.warehouses.Exwarehouse", {
                            _editType: "add",
                            callback: function(){
                                win.close();
                                me.storeProxy.loadPage(me.storeProxy.currentPage);
