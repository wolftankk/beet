Beet.registerMenu("settings", "customerAdmin", "会员管理",
    [
	{
	    text: "会员属性",
	    handler: function(){
		var item = Beet.cache.menus["customers.customerAttr"];
		if (!item){
		    Beet.workspace.addPanel("customers.customerAttr", "会员属性", {
			items: [
			    Ext.create("Beet.apps.customers.customerAttr")
			]
		    });    
		}else{
...
Ext.define("Beet.apps.customers.customerAttrStore", {
...
Ext.define("Beet.apps.customers.customerAttr", {
    ...
    initComponent: function(){
        ...
        Ext.apply(this, {
            storeProxy: Ext.create("Beet.apps.customers.customerAttrStore")
        });
