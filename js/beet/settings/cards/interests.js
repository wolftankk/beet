Ext.define("Beet.apps.cards.InterestsList", {
    ...
    buildStoreAndModel: function(metaData){
        ...
        if (!Ext.isDefined(Beet.apps.cards.InterestsModel)){
            Ext.define("Beet.apps.cards.InterestsModel", {
                extend: "Ext.data.Model",
                fields: fields
            });
        }

        if (!Ext.isDefined(Beet.apps.cards.InterestsStore)){
            Ext.define("Beet.apps.cards.InterestsStore", {
                extend: "Ext.data.Store",
                model: Beet.apps.cards.InterestsModel,
                autoLoad: true,
    ...
    createGrid: function(){
        ...
        Ext.apply(this, {
            storeProxy: Ext.create("Beet.apps.cards.InterestsStore")
        });
