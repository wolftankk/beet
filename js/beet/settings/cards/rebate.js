...
Ext.define("Beet.apps.cards.RebateList", {
    ...
    buildStoreAndModel: function(metaData){
        ...
        if (!Beet.apps.cards.RebateModel){
            Ext.define("Beet.apps.cards.RebateModel", {
                extend: "Ext.data.Model",
                fields: fields
            });
        }

        if (!Beet.apps.cards.RebateStore){
            Ext.define("Beet.apps.cards.RebateStore", {
                extend: "Ext.data.Store",
                model: Beet.apps.cards.RebateModel,
                autoLoad: true,
    ...
    createGrid: function(){
        ...
        Ext.apply(this, {
            storeProxy: Ext.create("Beet.apps.cards.RebateStore")
        });
